...
~~~
Не забываем, что данные проект не заменяет официальные руководства или описания, а служит подсказкой для бастрого погружения в необходимую часть предметной области!
~~~
